    ...
    return ( 
        <div className="container">
            ...
            <div className="txt">
                ...
                <p className='para intro'>Look around and use these links for your web projects. These websites/youtube videos have been my go to resources for over two years and they keep serving me to this day. Use them and make your coding life easier.</p>
            </div>
            <div className="cards">
